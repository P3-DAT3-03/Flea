...
namespace Flea.Models
{
    public class Cluster
    {
        ...
        /*TODO need to implement a function that checks if a placement is possible based on the cluster criterea, fx if it sould cause too many customers to be seated*/
        public bool VerifyPlacements => throw new NotImplementedException();

        /*TODO this function needs to make it possible for the cluster to assign reservations to tables, and verify if theyre correct based on a table and reservation as input*/
