...
public class Event
{
	...
	public Event(string name, DateTime dateTime)
    {
		...
		Clusters = new Cluster[] { new Cluster("A", 4, 8), new Cluster("B", 4, 8), new Cluster("C", 4, 8), new Cluster("D", 4, 8) };
...
public class Cluster
{
	...
	public int ReservationCount => Tables.Aggregate(0, ( acc, table) => table.TableReservation != null ? acc+1 : acc);
